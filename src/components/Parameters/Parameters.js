...
const Parameters = (props) => {
    let [brand, setBrand] = useState(props.prevData.brand ? props.prevData.brand : "");
    let [model, setModel] = useState(props.prevData.model ? props.prevData.model : "");
    ...
    const searchAction = () => {
        ...
        props.setPrevData(brand, model, props.prevData.category);
    }
